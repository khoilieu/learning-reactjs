  ...
  return (
    <div className="text-center">
      ...
      <p className="text-gray-500 mt-3">
        Chúng tôi tự hào cung cấp một bộ sưu tập đa dạng các khoá học trên nhiều lĩnh vực khác nhau, bao gồm lập trình, thiết kế đồ họa, kỹ năng mềm, tiếng Anh, marketing, quản lý dự án và nhiều lĩnh vực khác. Bất kể bạn quan tâm đến lĩnh vực nào, chúng tôi đều có khoá học phù hợp cho bạn, và tất cả đều có sẵn trên các trang web mà Savvy Hub hỗ trợ, như Udemy, Canva, ChatGPT,...
      </p>
      <Slider {...settings} className="mt-10">
        <div className='w-30 h-30 mx-auto mb-5'>
          <div className='flex justify-center items-center flex-col'>
          <img src={assets.nodejs} alt="Node Js" className="w-full h-full object-cover" style={{ width: '100px', height: '100px' }}  />
          <p className="mt-2 font-bold">Node Js</p>
          </div>
        </div>
        <div className='w-30 h-30 mx-auto mb-5'>
          <div className='flex justify-center items-center flex-col'>
          <img src={assets.html5} alt="HTML 5" className="w-full h-full object-cover" style={{ width: '100px', height: '100px' }}  />
          <p className="mt-2 font-bold">HTML 5</p>
          </div>
        </div>
        <div className='w-30 h-30 mx-auto mb-5'>
          <div className='flex justify-center items-center flex-col'>
          <img src={assets.jquery} alt="JQuery" className="w-full h-full object-cover" style={{ width: '100px', height: '100px' }}  />
          <p className="mt-2 font-bold">JQuery</p>
          </div>
        </div>
        <div className='w-30 h-30 mx-auto mb-5'>
          <div className='flex justify-center items-center flex-col'>
          <img src={assets.css} alt="CSS" className="w-full h-full object-cover" style={{ width: '100px', height: '100px' }}  />
          <p className="mt-2 font-bold">CSS</p>
          </div>
        </div>
        <div className='w-30 h-30 mx-auto mb-5'>
          <div className='flex justify-center items-center flex-col'>
          <img src={assets.react_native} alt="React Native" className="w-full h-full object-cover" style={{ width: '100px', height: '100px' }}  />
