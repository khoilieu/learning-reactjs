  ...
  return (
    <div className="text-center pt-20">
      ...
      <div className="flex flex-wrap justify-center items-center mt-10 space-x-0 md:space-x-10">
          ...
          <div className="p-6">
            <ul className="text-left mt-5 mb-5 ml-8 space-y-2">
              <li className="flex items-center">
                <span className="text-purple-700 mr-2">✔</span> <p className='text-sm text-gray-600'>Đầy đủ video</p>
              </li>
              <li className="flex items-center">
                <span className="text-purple-700 mr-2">✔</span> <p className='text-sm text-gray-600'>Không chặn download</p>
              </li>
              <li className="flex items-center">
                <span className="text-purple-700 mr-2">✔</span> <p className='text-sm text-gray-600'>Update miễn phí</p>
              </li>
              <li className="flex items-center">
                <span className="text-purple-700 mr-2">✔</span> <p className='text-sm text-gray-600'>24/7 Full support</p>
              </li>
            </ul>
        ...
        <div className="bg-blue-900 rounded-lg shadow-lg w-full md:w-80 mb-10 md:mb-0">
          <div className="bg-blue-900 text-left p-8 rounded-t-lg">
